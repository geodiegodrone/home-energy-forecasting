...
Dataset: [UCI Machine Learning Repository](https://doi.org/10.24432/C5VC8G), licensed CC BY 4.0. Dataset is downloaded at runtime and is not included in this repository. See [MODEL_CARD.md](MODEL_CARD.md) for intended use, evaluation design, limitations, attribution, and responsible-use notes.
